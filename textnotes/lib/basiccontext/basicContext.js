...
! function(n, t) {
    "undefined" != typeof module && module.exports ? module.exports = t() :
        "function" == typeof define && define.amd ? define(t) : window[n] = t()
...
const build = function(items) {
	...
	html += `
	        <div id='basicContextContainer' class='basicContextContainer'>
...
const show = function(items, e, fnClose, fnCallback) {
    ...
    let nodes = new DOMParser().parseFromString(html, 'text/html').body.childNodes[0]
    ...
    // Catch escape key to close the menu
    window.addEventListener("keydown", fnClose);
    window.basicContextFnClose = fnClose;
...
const close = function(e) {
    ...
    window.removeEventListener("keydown", window.basicContextFnClose);
    window.basicContextFnClose = null;
